<script>
    ...
    let icons = {
		...
		"download" : {
			box: 490,
			svg: `<path d="m245,0c-9.5,0 -17.2,7.7 -17.2,17.2l0,331.2l-58.8,-58.8c-6.7,-6.7 -17.6,-6.7 -24.3,0s-6.7,17.6 0,24.3l88.1,88.1c3.3,3.3 7.7,5 12.1,5c4.4,0 8.8,-1.7 12.1,-5l88.1,-88.1c6.7,-6.7 6.7,-17.6 0,-24.3c-6.7,-6.7 -17.6,-6.7 -24.3,0l-58.8,58.8l0,-331.3c0.1,-9.5 -7.5,-17.1 -17,-17.1z" id="svg_4"/><path d="m462.1,472.9l0,-99.7c0,-9.5 -7.7,-17.2 -17.2,-17.2s-17.2,7.7 -17.2,17.2l0,82.6l-365.5,0l0,-82.6c0,-9.5 -7.7,-17.2 -17.1,-17.2s-17.2,7.7 -17.2,17.2l0,99.7c0,9.5 7.7,17.1 17.2,17.1l399.8,0c9.5,0 17.2,-7.6 17.2,-17.1z" id="svg_5"/>`
		},
        "calendar" : {
          box: 16,
		...
		"favorite" : {
			box: 24,
			svg: `<g fill="currentColor" fill-rule="nonzero"><path d="M11.48 2.78a.5.5 0 0 1 .85-.08l.047.08 2.797 5.687 6.256.918a.5.5 0 0 1 .333.788l-.056.065-2.47 2.413a.5.5 0 0 1-.757-.646l.059-.069 1.746-1.709-5.516-.808a.5.5 0 0 1-.324-.191l-.052-.083-2.465-5.012-2.464 5.012a.5.5 0 0 1-.282.25l-.094.024-5.517.808 3.993 3.904a.5.5 0 0 1 .15.345l-.007.097-.942 5.511 4.93-2.602a.5.5 0 0 1 .627.133l.049.076a.5.5 0 0 1-.133.626l-.076.05-5.827 3.075a.5.5 0 0 1-.734-.446l.008-.08 1.068-6.253-4.527-4.425a.5.5 0 0 1 .194-.833l.083-.02 6.255-.918 2.798-5.688Z"></path><path d="M17 13.5a.5.5 0 0 1 .492.41l.008.09v6a.5.5 0 0 1-.992.09L16.5 20v-6a.5.5 0 0 1 .5-.5Z"></path><path d="M20 16.5a.5.5 0 0 1 .09.992L20 17.5h-6a.5.5 0 0 1-.09-.992L14 16.5h6Z"></path></g>`
		},
		"linkedin" : {
			box: 24,
		...
		"copy" : {
			box: 24,
			svg: `<g fill="currentColor" fill-rule="nonzero"><path d="M11.82 3.832 4.068 7.268a.5.5 0 0 0-.002.913l7.754 3.475a.5.5 0 0 0 .409 0l7.716-3.455a.5.5 0 0 0 0-.913l-7.716-3.455a.5.5 0 0 0-.407-.001Zm.203 1.004 6.494 2.908-6.494 2.908-6.525-2.925 6.525-2.891ZM3.83 16.088a.5.5 0 0 1 .575-.28l.085.029 7.55 3.383 7.511-3.364a.5.5 0 0 1 .617.174l.044.078a.5.5 0 0 1-.173.617l-.079.044-7.717 3.455a.5.5 0 0 1-.328.028l-.08-.028L4.08 16.75a.5.5 0 0 1-.252-.66Z"></path><path d="M3.83 11.803a.5.5 0 0 1 .575-.282l.085.03 7.55 3.383 7.511-3.363a.5.5 0 0 1 .617.173l.044.079a.5.5 0 0 1-.173.616l-.079.044-7.717 3.456a.5.5 0 0 1-.328.028l-.08-.028-7.754-3.476a.5.5 0 0 1-.252-.66Z"></path></g>`
		}
    };
